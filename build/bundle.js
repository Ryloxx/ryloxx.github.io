...
var app = (function () {
    ...
    */
    ...
    function create_if_block_1(ctx) {
    	let current;
    	const loader_slot_template = /*#slots*/ ctx[3].loader;
    	const loader_slot = create_slot(loader_slot_template, ctx, /*$$scope*/ ctx[2], get_loader_slot_context);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (loader_slot) {
    				if (loader_slot.p && dirty & /*$$scope*/ 4) {
    					update_slot(loader_slot, loader_slot_template, ctx, /*$$scope*/ ctx[2], dirty, get_loader_slot_changes, get_loader_slot_context);
    				}
    			}
    		},
    		i: function intro(local) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (error_slot) {
    				if (error_slot.p && dirty & /*$$scope*/ 4) {
    					update_slot(error_slot, error_slot_template, ctx, /*$$scope*/ ctx[2], dirty, get_error_slot_changes, get_error_slot_context);
    				}
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { error } = $$props, { loading } = $$props;
    	const writable_props = ["error", "loading"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Loadable> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ error, loading });
    	...
    	return [error, loading, $$scope, slots];
    }

    class Loadable extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { error: 0, loading: 1 });
...
C512,123.109,464.891,76,407,76z`;
    ...
    function navigationSlide(node, { show, duration, pauseBackgroundOnTransition, }) {
        ...
        const { showAnimation, hideAnimation } = makeAnimations(duration, pauseBackgroundOnTransition, 300);
        ...
        return {
            update: ({ show: newShow, duration: newDuration, pauseBackgroundOnTransition: newPauseBackgroundOnTransition, }) => {
                const { showAnimation, hideAnimation } = makeAnimations(newDuration, newPauseBackgroundOnTransition, 300);
                console.log(newShow);
    ...
    class MainStore extends CustomStore {
        ...
        async fetchCardData() {
            ...
            try {
                const data = await fetch('../projectData.json').then((response) => {
    ...
    const get_default_slot_context = ctx => ({ icon: /*item*/ ctx[5].icon });

    // (8:2) {#each items as item, index (index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			t = space();
    			attr_dev(div0, "class", "material-icons");
    			add_location(div0, file$2, 9, 6, 289);
    			attr_dev(div1, "class", "icon-field");
    			add_location(div1, file$2, 8, 4, 258);
    			this.first = div1;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (default_slot) {
    				if (default_slot.p && dirty & /*$$scope, items*/ 5) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:2) {#each items as item, index (index)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 6, 0, 193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*items, dispatch, $$scope*/ 7) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ createEventDispatcher, items, dispatch });
    	...
    	return [items, dispatch, $$scope, slots, click_handler];
    }
    ...
    function get_each_context_1(ctx, list, i) {
    	...
    	child_ctx[21] = list[i].callback;
    	child_ctx[22] = list[i].isSelected;
    	child_ctx[23] = list[i].to;
    	child_ctx[25] = i;
    	return child_ctx;
    }

    // (74:14) <NavLink                 active={isSelected}                 {index}                 {to}                 onClick={() => {                   navigationClick(to !== null);                   callback && callback();                 }}               >
    function create_default_slot_1(ctx) {
    	let t0_value = /*name*/ ctx[20] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*navLinks*/ 2 && t0_value !== (t0_value = /*name*/ ctx[20] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(74:14) <NavLink                 active={isSelected}                 {index}                 {to}                 onClick={() => {                   navigationClick(to !== null);                   callback && callback();                 }}               >",
    		ctx
    	});
    ...
    // (73:12) {#each navLink.links as { name, callback, isSelected, to }
    function create_each_block_1(key_1, ctx) {
    	...
    	function func() {
    		return /*func*/ ctx[13](/*to*/ ctx[23], /*callback*/ ctx[21]);
    	}

    	navlink = new NavLink({
    			props: {
    				active: /*isSelected*/ ctx[22],
    				index: /*index*/ ctx[25],
    				to: /*to*/ ctx[23],
    				onClick: func,
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*navLinks*/ 2) navlink_changes.active = /*isSelected*/ ctx[22];
    			if (dirty & /*navLinks*/ 2) navlink_changes.index = /*index*/ ctx[25];
    			if (dirty & /*navLinks*/ 2) navlink_changes.to = /*to*/ ctx[23];
    			if (dirty & /*navLinks*/ 2) navlink_changes.onClick = func;

    			if (dirty & /*$$scope, navLinks*/ 67108866) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(73:12) {#each navLink.links as { name, callback, isSelected, to }",
    		ctx
    	});
    ...
    // (69:6) {#each navLinks as navLink}
    function create_each_block$1(ctx) {
    	let div2;
    	let div0;
    	let t0_value = /*navLink*/ ctx[17].title + "";
    	let t0;
    	let t1;
    	let div1;
    	let each_blocks = [];
    	...
    	let t2;
    	let current;
    	let each_value_1 = /*navLink*/ ctx[17].links;
    	validate_each_argument(each_value_1);
    	const get_key = ctx => /*name*/ ctx[20];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 70, 10, 1944);
    			attr_dev(div1, "class", "nav-block-list");
    			add_location(div1, file$3, 71, 10, 2006);
    			attr_dev(div2, "class", "nav-block");
    			add_location(div2, file$3, 69, 8, 1910);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*navLinks*/ 2) && t0_value !== (t0_value = /*navLink*/ ctx[17].title + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*navLinks, navigationClick*/ 130) {
    				each_value_1 = /*navLink*/ ctx[17].links;
    				validate_each_argument(each_value_1);
    				group_outros();
    				validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(69:6) {#each navLinks as navLink}",
    		ctx
    	});
    ...
    // (90:4) <NavLinkIconList       items={iconActions}       let:icon       on:navigation={(event) => {         truth.changeRoute(event.detail);         navigationClick(true);       }}     >
    function create_default_slot(ctx) {
    	let t_value = /*icon*/ ctx[16] + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*icon*/ 65536 && t_value !== (t_value = /*icon*/ ctx[16] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(90:4) <NavLinkIconList       items={iconActions}       let:icon       on:navigation={(event) => {         truth.changeRoute(event.detail);         navigationClick(true);       }}     >",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	navlinkiconlist.$on("navigation", /*navigation_handler*/ ctx[14]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$3, 42, 4, 1243);
    			attr_dev(div0, "id", "background--wrapper");
    			add_location(div0, file$3, 41, 2, 1208);
    			...
    			add_location(div1, file$3, 44, 2, 1322);
    			attr_dev(div2, "class", "material-icons close-button");
    			toggle_class(div2, "v-hidden", !/*showButton*/ ctx[3]);
    			add_location(div2, file$3, 56, 4, 1592);
    			attr_dev(div3, "class", "nav-top");
    			add_location(div3, file$3, 66, 4, 1801);
    			attr_dev(div4, "class", "nav-main");
    			add_location(div4, file$3, 67, 4, 1845);
    			attr_dev(nav, "id", "main-nav");
    			add_location(nav, file$3, 55, 2, 1539);
    			attr_dev(div5, "id", "main-nav--wrapper");
    			attr_dev(div5, "class", "svelte-sfo6vs");
    			toggle_class(div5, "show", /*$navigationOpen*/ ctx[5]);
    			add_location(div5, file$3, 31, 0, 971);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, icon*/ 67174400) {
    				navlinkiconlist_changes.$$scope = { dirty, ctx };
    			}

    			navlinkiconlist.$set(navlinkiconlist_changes);

    			if (navigationSlide_action && is_function(navigationSlide_action.update) && dirty & /*$navigationOpen*/ 32) navigationSlide_action.update.call(null, {
    				show: /*$navigationOpen*/ ctx[5],
    				duration: NAVIGATION_SLIDE_DURATION,
    				pauseBackgroundOnTransition: truth.isMobile
    			});

    			if (dirty & /*$navigationOpen*/ 32) {
    				toggle_class(div5, "show", /*$navigationOpen*/ ctx[5]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, truth, $$value => $$invalidate(9, $truth = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	component_subscribe($$self, navigationOpen, value => $$invalidate(5, $navigationOpen = value));
    	let showButton;
    	let navElement;
    	let cv;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("navElement" in $$props) $$invalidate(4, navElement = $$props.navElement);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$truth*/ 512) {
    			 $$invalidate(3, showButton = $truth.isSmallDevice);
    		}

    		if ($$self.$$.dirty & /*cv, colors*/ 260) {
    			 cv && setBackground({
    				bgcolor: null,
    				canvas: cv,
    ...
    class Navigation extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { iconActions: 0, navLinks: 1, colors: 8 });
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 46, 0, 1151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\components\\card\\CardParagraph.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "card-paragraph-body-list svelte-lo7657");
    			toggle_class(ul, "card-paragraph-body-list-pins", /*isPins*/ ctx[4]);
    			add_location(ul, file$6, 10, 6, 340);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "svelte-lo7657");
    			add_location(li, file$6, 15, 10, 485);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	let t2;
    	let t3;
    	let if_block = /*list*/ ctx[3]?.length && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "style", div0_style_value = `color:${/*color*/ ctx[0]}`);
    			add_location(div0, file$6, 4, 2, 172);
    			add_location(p, file$6, 6, 4, 285);
    			attr_dev(div1, "class", "card-paragraph-body");
    			add_location(div1, file$6, 5, 2, 247);
    			attr_dev(div2, "class", "card-paragraph");
    			add_location(div2, file$6, 3, 0, 141);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*color*/ 1 && div0_style_value !== (div0_style_value = `color:${/*color*/ ctx[0]}`)) {
    				attr_dev(div0, "style", div0_style_value);
    			}

    			if (dirty & /*body*/ 4) set_data_dev(t2, /*body*/ ctx[2]);

    			if (/*list*/ ctx[3]?.length) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["color", "title", "body", "list", "isPins"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("isPins" in $$props) $$invalidate(4, isPins = $$props.isPins);
    	};

    	$$self.$capture_state = () => ({ color, title, body, list, isPins });
    	...
    	return [color, title, body, list, isPins];
    }
    ...
    class CardParagraph extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*color*/ ctx[0] === undefined && !("color" in props)) {
    			console.warn("<CardParagraph> was created without expected prop 'color'");
    		}
    ...
    const file$7 = "src\\components\\card\\CardBody.svelte";

    // (68:6) {#if info.features}
    function create_if_block_1$1(ctx) {
    	...
    	cardparagraph = new CardParagraph({
    			props: {
    				...
    				color: /*info*/ ctx[0].theme.textSubHead
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*info*/ 1) cardparagraph_changes.color = /*info*/ ctx[0].theme.textSubHead;
    ...
    function create_fragment$9(ctx) {
    	...
    	let if_block0 = /*info*/ ctx[0].features && create_if_block_1$1(ctx);
    	...
    	let if_block1 = /*info*/ ctx[0].code && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 58, 4, 1931);
    			attr_dev(div1, "class", "card-top");
    			attr_dev(div1, "style", div1_style_value = `color:${/*info*/ ctx[0].theme.textMainHead}`);
    			add_location(div1, file$7, 57, 2, 1861);
    			attr_dev(div2, "class", "card-body");
    			add_location(div2, file$7, 61, 4, 2013);
    			attr_dev(div3, "class", "card-link--wrapper");
    			add_location(div3, file$7, 81, 4, 2475);
    			attr_dev(div4, "class", "card-main");
    			add_location(div4, file$7, 60, 2, 1985);
    			attr_dev(article, "style", article_style_value = `--color:${/*info*/ ctx[0].theme.textBody};--image:url(.${/*info*/ ctx[0].logo || defaultBackdrop});--color-marker:${/*info*/ ctx[0].theme.tertiary};--bg-color:${/*info*/ ctx[0].theme.primary}`);
    			attr_dev(article, "class", "card-content svelte-462m0h");
    			add_location(article, file$7, 50, 0, 1633);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*info*/ 1 && div1_style_value !== (div1_style_value = `color:${/*info*/ ctx[0].theme.textMainHead}`)) {
    				attr_dev(div1, "style", div1_style_value);
    			}

    			const cardparagraph0_changes = {};
    			if (dirty & /*info*/ 1) cardparagraph0_changes.body = /*info*/ ctx[0].body;
    			if (dirty & /*info*/ 1) cardparagraph0_changes.color = /*info*/ ctx[0].theme.textSubHead;
    			...
    			if (dirty & /*info*/ 1) cardparagraph1_changes.color = /*info*/ ctx[0].theme.textSubHead;
    			...
    			if (!current || dirty & /*info*/ 1 && article_style_value !== (article_style_value = `--color:${/*info*/ ctx[0].theme.textBody};--image:url(.${/*info*/ ctx[0].logo || defaultBackdrop});--color-marker:${/*info*/ ctx[0].theme.tertiary};--bg-color:${/*info*/ ctx[0].theme.primary}`)) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		if (playAnimation) $$invalidate(5, animation = gsapWithCSS.timeline({
    		...
    		}).from(container.querySelectorAll(".card-top, .card-paragraph-title"), {
    			x: -60,
    			alpha: 0,
    			duration: 0.3,
    			stagger: 0.2
    		}).from(container.querySelectorAll(".card-paragraph-body p, .card-paragraph-body-list:not(.card-paragraph-body-list-pins)"), { y: 30, alpha: 0, duration: 0.3 }).from(container.querySelectorAll(".card-body .card-paragraph-body-list-pins li"), {
    			alpha: 0,
    			scale: 0.5,
    			duration: 0.2,
    			stagger: 0.1,
    			...
    			container.querySelectorAll(".card-link"),
    			{
    				x: -60,
    				alpha: 0,
    				stagger: -0.15,
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-pktgkm");
    			add_location(img, file$8, 34, 8, 929);
    			attr_dev(div0, "class", "card-picture-image svelte-pktgkm");
    			attr_dev(div0, "style", div0_style_value = `--url:url(${/*src*/ ctx[5]})`);
    			add_location(div0, file$8, 33, 6, 860);
    			attr_dev(div1, "class", "card-picture svelte-pktgkm");
    			toggle_class(div1, "hidden", /*hidden*/ ctx[3]);
    			add_location(div1, file$8, 32, 4, 814);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if_block1.c();
    			attr_dev(div0, "class", "outer-body svelte-pktgkm");
    			toggle_class(div0, "hidden", !/*show*/ ctx[4]);
    			add_location(div0, file$8, 38, 2, 994);
    			attr_dev(div1, "class", "card");
    			attr_dev(div1, "style", div1_style_value = `background-color:${/*info*/ ctx[0].theme.tertiary}`);
    			add_location(div1, file$8, 18, 0, 590);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*info*/ 1 && div1_style_value !== (div1_style_value = `background-color:${/*info*/ ctx[0].theme.tertiary}`)) {
    				attr_dev(div1, "style", div1_style_value);
    			}
    		},
    		i: function intro(local) {
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 4, 2, 124);
    			attr_dev(p, "class", "page-paragraph-body");
    			add_location(p, file$9, 6, 4, 197);
    			attr_dev(div1, "class", "page-paragraph");
    			add_location(div1, file$9, 5, 2, 164);
    			attr_dev(div2, "class", "page");
    			add_location(div2, file$9, 3, 0, 103);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	return [title, text, $$scope, slots];
    }

    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { title: 0, text: 1 });
    ...
    class ListenKeyboard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { actions: 0 });
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	let text = `My name is Alain, 24 years old. I use the pseudo "Rylox" on the internet.
      ...
      and useful to people`;
    	...
    	$$self.$capture_state = () => ({ Page, text, title });
    ...
    const file$a = "src\\views\\ContactView.svelte";
    ...
    function create_default_slot$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*loaded*/ ctx[0] && create_if_block$5(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "anchor material-icons svelte-fp1n4h");
    			add_location(a, file$a, 16, 8, 421);
    			attr_dev(div0, "class", "material-icons anchor-container svelte-fp1n4h");
    			add_location(div0, file$a, 14, 6, 347);
    			add_location(div1, file$a, 12, 4, 295);
    			attr_dev(div2, "class", "or");
    			add_location(div2, file$a, 26, 4, 637);
    			attr_dev(iframe, "id", "contact-form");
    			attr_dev(iframe, "title", "contact form");
    			if (iframe.src !== (iframe_src_value = "https://docs.google.com/forms/d/e/1FAIpQLSd9AXUUoE3E5mAiHn84FdHd0b9gx1FDTaS24gPfez-MUdHhRQ/viewform?embedded=true")) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "marginheight", "0");
    			attr_dev(iframe, "marginwidth", "0");
    			attr_dev(iframe, "class", "svelte-fp1n4h");
    			toggle_class(iframe, "fly", /*loaded*/ ctx[0]);
    			toggle_class(iframe, "v-hidden", !/*loaded*/ ctx[0]);
    			add_location(iframe, file$a, 33, 8, 803);
    			attr_dev(div3, "class", "iframe-wrapper svelte-fp1n4h");
    			add_location(div3, file$a, 29, 6, 709);
    			add_location(div4, file$a, 27, 4, 666);
    			attr_dev(article, "class", "svelte-fp1n4h");
    			add_location(article, file$a, 11, 2, 281);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article, anchor);
    			append_dev(article, div1);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(a, "click", feedbackTouch, false, false, false),
    					listen_dev(iframe, "load", /*load_handler*/ ctx[1], false, false, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:0) <Page title={'Contact'}>",
    		ctx
    	});
    ...
    function instance$h($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fly, Loader, Page, feedbackTouch, loaded });
    ...
    function create_loader_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 60, 2, 2041);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_error_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$b, 64, 4, 2110);
    			attr_dev(button, "class", "material-icons");
    			add_location(button, file$b, 67, 4, 2213);
    			attr_dev(div0, "slot", "error");
    			add_location(div0, file$b, 63, 2, 2087);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$b, 56, 4, 1932);
    			attr_dev(div1, "id", "main-view-wrapper");
    			add_location(div1, file$b, 55, 2, 1899);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(50:0) <Loadable {error} {loading}>",
    		ctx
    	});
    ...
    function create_key_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "key",
    		source: "(75:0) {#key $truth.currentRoute}",
    		ctx
    	});
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(meta, file$b, 47, 2, 1703);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, $truth, colors, projectLinks*/ 8203) {
    ...
    function instance$i($$self, $$props, $$invalidate) {
    	...
    	let $cardsStore,
    		...
    		$$subscribe_cardsStore = () => ($$unsubscribe_cardsStore(), $$unsubscribe_cardsStore = subscribe(cardsStore, $$value => $$invalidate(10, $cardsStore = $$value)), cardsStore);
    	...
    	const { navigationOpen } = truth;
    	validate_store(navigationOpen, "navigationOpen");
    	component_subscribe($$self, navigationOpen, value => $$invalidate(11, $navigationOpen = value));
    	const writable_props = [];
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$cardsStore, $navigationOpen, $truth*/ 3073) {
    			 $$invalidate(1, projectLinks = $cardsStore.data && {
    				title: "Projects",
    				links: $cardsStore.data.map(({ title }, index) => ({
    					name: title,
    					callback: () => {
    						if (!$navigationOpen && $truth.currentRoute === ROUTES.CARD) {
    							setTimeout(
    								() => {
    									truth.selectCard(index);
    								},
    								NAVIGATION_SLIDE_DURATION / 1.5
    							);
    						} else {
    							truth.selectCard(index);
    						}
    		...
    		if ($$self.$$.dirty & /*$cardsStore, _a*/ 1280) {
    			 $$invalidate(3, colors = ($$invalidate(8, _a = $cardsStore.data) === null || _a === void 0
    			? void 0
    			: _a.map(card => card.theme.primary)) || ["white"]);
    		}

    		if ($$self.$$.dirty & /*$cardsStore, _b*/ 1536) {
    			 $$invalidate(4, error = $$invalidate(9, _b = $cardsStore.error) === null || _b === void 0
    			? void 0
    			: _b.message);
    		}

    		if ($$self.$$.dirty & /*$cardsStore*/ 1024) {
